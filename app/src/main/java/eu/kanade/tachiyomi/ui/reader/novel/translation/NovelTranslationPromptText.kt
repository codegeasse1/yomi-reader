    ...
    return when (family) {
        NovelTranslationPromptFamily.RUSSIAN -> {
            "TRANSLATE from $sourceLang to $targetLang.\n" +
                ...
                "2. Return EXACTLY one <s i='N'>...</s> block for every input block " +
                "and preserve every original i value.\n" +
                "3. Never merge, skip, renumber, duplicate, summarize, or reorder blocks. " +
                "If a block is empty or untranslatable, copy it inside its original tag.\n" +
