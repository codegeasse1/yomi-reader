...
/**
 * Shared shell runner for Shizuku-based extension installers.
 *
 ...
 */
internal object ShizukuShellRunner {

    private const val TIMEOUT_SECONDS = 120L

    val PACKAGE_NAME_REGEX = Regex("""^[a-zA-Z_][a-zA-Z0-9_]*(\.[a-zA-Z_][a-zA-Z0-9_]*)+$""")
    ...
    /**
     * Executes [cmdarray] through a Shizuku-managed process.
     *
