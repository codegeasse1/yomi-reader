...
class AnimeMigrationConfigScreen(private val animeIds: Collection<Long>) : Screen() {
    ...
    override fun Content() {
        ...
        val screenModel = rememberScreenModel { AnimeMigrationConfigScreenModel() }
        ...
        fun continueMigration(openSheet: Boolean, extraSearchQuery: String?) {
            ...
            if (animeId != null) {
                navigator.replace(MigrateAnimeSearchScreen(animeId))
                return
            }
                                ...
                                AppBar.Action(
                                    ...
                                    onClick = {
                                        screenModel.toggleSelection(
                                            AnimeMigrationConfigScreenModel.SelectionConfig.All,
                                        )
                                    },
                                ),
                                AppBar.Action(
                                    ...
                                    onClick = {
                                        screenModel.toggleSelection(
                                            AnimeMigrationConfigScreenModel.SelectionConfig.None,
                                        )
                                    },
                                ),
                            ),
    ...
    private fun LazyItemScope.SourceItemContainer(
        firstItem: Boolean,
        lastItem: Boolean,
        source: AnimeMigrationConfigScreenModel.MigrationSource,
        onClick: () -> Unit,
    ) {
            ...
            ListItem(
                headlineContent = {
                    Row(
                        ...
                        AnimeSourceIcon(source = source.source)
                        Text(
