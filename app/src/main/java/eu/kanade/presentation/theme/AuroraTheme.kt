...
data class AuroraColors(
    ...
    companion object {
        ...
        val Dark = AuroraColors(
            ...
            glass = Color.White.copy(alpha = 0.26f),
            textPrimary = Color(0xFFECEAFD),
            textSecondary = Color(0xFFA6A3CC),
            textOnAccent = Color(0xFF171032),
            cardBackground = Color.White.copy(alpha = 0.14f),
